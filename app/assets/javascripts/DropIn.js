function DropIn(config){
  ...
  this.button = this.paymentForm.find('#BT-btn');
...
DropIn.prototype.initialize = function(){
  var self = this;
...
DropIn.prototype.events = function(){
  var self = this;
...
DropIn.prototype.labelHander = function(element){
  var self = this;
  var input = element;
...
DropIn.prototype.notify = function(status){
  var self = this;
